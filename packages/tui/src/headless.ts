...
/**
 * Headless widget render: no `process`, no stdout, no terminal I/O.
 * Public entry: `@mudah-cli/tui/wasi` (and `@mudah-cli/tui/headless`).
...
/** Headless inspect tree as JSON text (still no process / fs). */
